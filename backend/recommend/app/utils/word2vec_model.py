...
# 저장된 모델 로드
def load_word2vec_model(model_path="app/word2vec_model.model"):
    """Word2Vec 모델을 로드합니다."""
...
def get_similar_words_with_T(model, words_list, topn=15):
    ...
    # 상위 topn개의 단어만 반환
    return split_title_and_year([word for word, _ in sorted_similar_words[:topn]])

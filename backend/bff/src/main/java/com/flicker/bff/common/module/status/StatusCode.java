package com.flicker.bff.common.module.status;
...
public enum StatusCode {
    ...
    public static StatusCode of(int httpStatus, int serviceStatus, String message) {
        for (StatusCode statusCode : values()) {
            if (statusCode.httpStatus.value() == httpStatus && statusCode.serviceStatus == serviceStatus && statusCode.message.equals(message)) {
                return statusCode;
            }
        }
        return StatusCode.NOT_CUSTOM_ERROR;
    }
}